...
void setup(void) {
  ...
  for(int x=0; x<matrix.width(); x++) {
    ...
    matrix.drawLine(x, 0, x, 16,  matrix.color565(x * 8, 0, 0));
  }
...
//   26, // G1 (your G pin)
//   17, // B1 (your B pin)
//   5, // R2 (unused - set to -1)
//   27, // G2 (unused - set to -1)
//   18  // B2 (unused - set to -1)
// };// Your Address pins: You only need A and B for 16 rows (1:4 scan)
// uint8_t addrPins[] = {
//   19, // A
//   14, // B
//   21, // C
...
// //   Serial.begin(115200);
// //   delay(1000);
// //   Serial.println("\n--- ESP32 GPIO Register Check ---");
// // }

// // void loop() {
// //   // Your relevant pins
// //   int pins[] = {21, 22, 23, 18, 12, 14, 27}; // R, G, B, CLK

// //   for (int pin : pins) {
// //     if (pin >= 0 && pin <= 31) {
// //       // Pins 0-31 are in the low-order register (Bank 0)
// //       Serial.print("Pin ");
// //       Serial.print(pin);
// //       Serial.println(" is in Bank 0 (GPIO 0-31).");
// //     } else if (pin >= 32 && pin <= 39) {
// //       // Pins 32-39 are in the high-order register (Bank 1)
// //       Serial.print("Pin ");
// //       Serial.print(pin);
// //       Serial.println(" is in Bank 1 (GPIO 32-39).");
// //     } else {
// //       Serial.print("Pin ");
// //       Serial.print(pin);
// //       Serial.println(" is not a valid standard GPIO pin.");
// //     }
// //   }
...
// void loop(void) {
//   matrix.fillScreen(0); matrix.show(); delay(500);
//   matrix.fillScreen(0xFFFF); matrix.show(); delay(500);
//   matrix.fillScreen(0b1111100000000000);matrix.show(); delay(500);
//   matrix.fillScreen(0b0000011111100000);matrix.show(); delay(500);
//   matrix.fillScreen(0b0000000000111111);matrix.show(); delay(500);
//   delay(3000);
//   return;
//   // Make four color bars (red, green, blue, white) with brightness ramp:
//   for(int x=0; x<matrix.width(); x++) {
